    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 bg-white">
                ...
                >
                    ...
                    <div className="mb-10">
                        <h2 className="text-4xl font-black tracking-tighter text-[#0a1a10] mb-3 uppercase italic leading-[0.9]">
                            Start Your <br /> <span className="text-primary not-italic">Elite Journey.</span>
                        </h2>
                        <p className="text-sm font-bold text-slate-400">Join 50,000+ members enjoying 15-minute delivery.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-16 bg-[#0a1a10] text-white rounded-2xl font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 transition-all hover:bg-primary hover:text-[#0a1a10] hover:scale-[1.02] active:scale-95 shadow-xl disabled:opacity-50 group"
                        >
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-sm font-bold text-slate-400">
                            Already a member?{" "}
                            <Link href="/login" className="text-primary hover:underline font-black uppercase tracking-widest text-[10px] ml-2 italic">
                                Sign In &rarr;
                            </Link>
                        </p>
                    </div>
            ...
            <div className="relative hidden lg:flex flex-col justify-end p-20 overflow-hidden order-1 lg:order-2 bg-[#0a1a10]">
                ...
                <div className="absolute bottom-[-10%] left-[-10%] w-[60%] h-[60%] bg-primary/10 blur-[150px] rounded-full" />
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <h3 className="text-6xl font-black text-white italic tracking-tighter uppercase leading-[0.8] mb-8">
                        The <span className="text-primary not-italic">Gold Standard</span> <br /> of Delivery.
                    </h3>

                    <div className="grid grid-cols-2 gap-8">
                        <div className="space-y-2">
                            <Zap className="text-primary mb-2" size={32} />
                            <p className="text-white font-black uppercase italic tracking-widest text-xs">15 Min Speed</p>
                            <p className="text-[#8ecca3] text-xs font-bold opacity-60">Record-breaking logistics across 42 cities.</p>
                        </div>
                        <div className="space-y-2">
                            <CheckCircle2 className="text-primary mb-2" size={32} />
                            <p className="text-white font-black uppercase italic tracking-widest text-xs">Quality First</p>
                            <p className="text-[#8ecca3] text-xs font-bold opacity-60">Directly sourced heritage organic produce.</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 pt-10 border-t border-white/10 flex items-center gap-6">
                        <div className="flex -space-x-3">
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="w-10 h-10 rounded-full border-2 border-[#0a1a10] bg-slate-200 overflow-hidden">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#8ecca3]">Trusted by London&apos;s finest</p>
                    </div>
                </div>

                {/* Floating Credit Badge */}
                <div className="absolute top-20 right-20 bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-[2rem] transform rotate-6 hover:rotate-0 transition-transform cursor-default">
                    <p className="text-primary font-black text-3xl italic tracking-tighter leading-none mb-1">FREE</p>
                    <p className="text-white font-black uppercase tracking-widest text-[10px]">On first 3 orders</p>
                </div>
            </div>
        </div>
    );
